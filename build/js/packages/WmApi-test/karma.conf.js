...
config.set({
  "singleRun": true,
  "autoWatch": false,
  "basePath": "C:\\Users\\Daniel\\IdeaProjects\\WmApi\\build\\js\\packages\\WmApi-test\\node_modules",
  "files": [
    "C:\\Users\\Daniel\\IdeaProjects\\WmApi\\build\\js\\packages\\WmApi-test\\adapter-browser.js"
  ],
  "frameworks": [
    "mocha"
  ],
...
;(function(config) {
    ...
    const handler = (percentage, message, ...args) => {
        ...
        msg = msg.replace(new RegExp("C:\\Users\\Daniel\\IdeaProjects\\WmApi\\build\\js", 'g'), '');;
        console.log(msg);
    };
